  ...
  !function (e, t) {
    kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
      ...
      kendo.ui.Upload && (kendo.ui.Upload.prototype.options.localization = e.extend(!0, kendo.ui.Upload.prototype.options.localization, {
        ...
        uploadFail: "Ошибка во время загрузки",
        statusWarning: "Внимание",
        invalidFileExtension: "Недопустимый тип файла",
        invalidMaxFileSize: "Превышен максимальный размер файла",
        clearSelectedFiles: "Очистить",
        invalidMinFileSize: "Размер файла меньше допустимого",
        headerStatusPaused: "Пауза",
        resume: "Итог",
        pause: "Пауза"
      })),
