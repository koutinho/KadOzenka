...
{
	public class PlacementsConfigurationModel : IValidatableObject
	{
		...
		public InputParametersForPlacements MapToInputParameters()
		{
			return new InputParametersForPlacements
			{
