...
namespace KadOzenka.Web.Models.Declarations
{
	public class ParcelCharacteristicsModel
	{
		...
		public static ParcelCharacteristicsModel FromEntity(OMHarParcel entity, List<OMHarParcelAdditionalInfo> additionalInfos)
		{
			...
			{
				Id = entity.Id,
				Address = new CharacteristicModel { Value = entity.Har_1, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_1))) },
				Square = new CharacteristicModel { Value = entity.Har_2, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_2))) },
				LandCategory = new CharacteristicModel { Value = entity.Har_3, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_3))) },
				PermittedUseType = new CharacteristicModel { Value = entity.Har_4, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_4))) },
				FactUse = new CharacteristicModel { Value = entity.Har_5, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_5))) },
				NaturalObjectsInformation = new CharacteristicModel { Value = entity.Har_6, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_6))) },
				ZonesWithSpecialUsingConditionsInformation = new CharacteristicModel { Value = entity.Har_7, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_7))) },
				ProtectedNaturalZonesInformation = new CharacteristicModel { Value = entity.Har_8, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_8))) },
				EconomicZonesInformation = new CharacteristicModel { Value = entity.Har_9, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_9))) },
				EstablishedEasementsInformation = new CharacteristicModel { Value = entity.Har_10, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_10))) },
				DistanceFromPavedRoads = new CharacteristicModel { Value = entity.Har_11, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_11))) },
				PrecenceOfAccessRoads = new CharacteristicModel { Value = entity.Har_12, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_2))) },
				CommunicationsDescription = new CharacteristicModel { Value = entity.Har_13, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13))) },
				ConnectionToPowerGrids = new CharacteristicModel { Value = entity.Har_13_1_1_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_1_1))) },
				AvailabilityConnectionToPowerGrids = new CharacteristicModel { Value = entity.Har_13_1_2_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_2_1))) },
				ElectricPower = new CharacteristicModel { Value = entity.Har_13_1_3, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_1_3))) },
				ConnectionToGasGrids = new CharacteristicModel { Value = entity.Har_13_2_1_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_2_1))) },
				AvailabilityConnectionToGasGrids = new CharacteristicModel { Value = entity.Har_13_2_2_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_2_2))) },
				GasPower = new CharacteristicModel { Value = entity.Har_13_2_3, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_2_3))) },
				ConnectionToWaterSupply = new CharacteristicModel { Value = entity.Har_13_3_1_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_3_1))) },
				AvailabilityConnectionToWaterSupply = new CharacteristicModel { Value = entity.Har_13_3_2_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_3_2))) },
				ConnectionToHeatSupply = new CharacteristicModel { Value = entity.Har_13_4_1_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_4_1))) },
				AvailabilityConnectionToHeatSupply = new CharacteristicModel { Value = entity.Har_13_4_2_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_4_2))) },
				ConnectionToWaterDisposal = new CharacteristicModel { Value = entity.Har_13_5_1_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_5_1))) },
				AvailabilityConnectionToWaterDisposal = new CharacteristicModel { Value = entity.Har_13_5_2_Code, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_13_5_2))) },
				NearestWaterbodyDistance = new CharacteristicModel { Value = entity.Har_14, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_14))) },
				NearestRecreationalZoneDistance = new CharacteristicModel { Value = entity.Har_15, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_15))) },
				RailwaysDistance = new CharacteristicModel { Value = entity.Har_16, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_16))) },
				RailwayStationsDistance = new CharacteristicModel { Value = entity.Har_17, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_17))) },
				MiningZoneDistance = new CharacteristicModel { Value = entity.Har_18, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_18))) },
				TypeOfLand = new CharacteristicModel { Value = entity.Har_19, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_19))) },
				SoilConditionIndicators = new CharacteristicModel { Value = entity.Har_20, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_20))) },
				DisadvantagesPresence = new CharacteristicModel { Value = entity.Har_21, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos.FirstOrDefault(x => x.HarParcelName == nameof(entity.Har_21))) },
			};
		}
