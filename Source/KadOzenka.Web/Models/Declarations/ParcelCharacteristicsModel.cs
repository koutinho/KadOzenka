	...
	public class ParcelCharacteristicsModel
	{
		...
		public static ParcelCharacteristicsModel FromEntity(OMHarParcel entity, List<OMHarParcelAdditionalInfo> additionalInfos)
		{
			return new ParcelCharacteristicsModel
			{
				...
				PrecenceOfAccessRoads = new CharacteristicModel { Value = entity?.Har_12, AdditionalInfo = CharacteristicAdditionalInfoModel.FromEntity(additionalInfos?.FirstOrDefault(x => entity != null && x.HarParcelName == nameof(entity.Har_2))) },
