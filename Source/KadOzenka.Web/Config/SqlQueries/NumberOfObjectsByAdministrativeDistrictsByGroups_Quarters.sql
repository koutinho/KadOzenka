...
SELECT CadastralQuartal, CadastralDistrict, DistrictCode, RegionCode, ParentGroup, count(id) AS objectsCount FROM data 
GROUP BY (data.CadastralQuartal, data.CadastralDistrict, data.DistrictCode, data.RegionCode, data.ParentGroup)
