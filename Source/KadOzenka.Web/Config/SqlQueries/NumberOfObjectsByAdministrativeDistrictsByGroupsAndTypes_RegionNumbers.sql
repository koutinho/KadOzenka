...
SELECT
        ...
        substring(L1_R201.CADASTRAL_BLOCK from 1 for 5) AS CadastralQuartal,
...
SELECT DistrictCode, CadastralQuartal, PropertyTypeCode, count(id) AS objectsCount, ParentGroup FROM cte1
