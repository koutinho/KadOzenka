...
$site = "CIPJS_KO_TEST"
$IIS_siteName = "CIPJS_KO_TEST"
$IIS_siteName2 = "CIPJS_KO_TEST_AD"
$IIS_WebAppPoolName = "CIPJS_KO_TEST"
$IIS_WebAppPoolName2 = "CIPJS_KO_TEST_AD"
...
$service_dir = "C:\CIPJSKOWindowsServiceTest\PlugIns"
...
$service_array = @("KadOzenka.Dal.dll", "KadOzenka.ObjectModel.dll", "Platform.dll", "Platform.Reports.dll", "Platform.Web.dll")
