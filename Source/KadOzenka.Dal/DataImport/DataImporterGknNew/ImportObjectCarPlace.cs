...
namespace KadOzenka.Dal.DataImport.DataImporterGknNew
{
	public class ImportObjectCarPlace : ImportObjectBase<xmlObjectCarPlace>
    {
		...
		protected override void ImportObject(xmlObjectCarPlace current, DateTime unitDate, long idTour, long idTask, KoNoteType koNoteType, DateTime sDate, DateTime otDate, long idDocument)
        {
