...
namespace KadOzenka.Dal.DataImport.DataImporterGknNew
{
	public class ImportObjectBuild : ImportObjectBase<xmlObjectBuild>
    {
        ...
        protected override void ImportObject(xmlObjectBuild current, DateTime unitDate, long idTour, long idTask, KoNoteType koNoteType, DateTime sDate, DateTime otDate, long idDocument)
        {
