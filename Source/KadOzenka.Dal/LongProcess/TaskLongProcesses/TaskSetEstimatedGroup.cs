	...
	public class TaskSetEstimatedGroup : LongProcess
	{
		...
		public override void StartProcess(OMProcessType processType, OMQueue processQueue, CancellationToken cancellationToken)
		{
			try
			{
				...
				LongProcessProgressLogger.StartLogProgress(processQueue, () => koObjectSetEstimatedGroup.CountAllUnits,
					() => koObjectSetEstimatedGroup.CurrentCount);
			...
			catch (EmptyActiveModelForGroupWithFactorValueCheckException e)
			{
				_log.Error(e, "Операция присвоения оценочной группы завершена с ошибкой");
				LongProcessProgressLogger.StopLogProgress();
				NotificationSender.SendNotification(processQueue, "Присвоение оценочной группы",
					e.Message);
			...
			catch (Exception e)
			{
				...
				LongProcessProgressLogger.StopLogProgress();
				NotificationSender.SendNotification(processQueue, "Присвоение оценочной группы",
					$"Присвоение оценочной группы завершено с ошибкой. Подробнее в журнале ошибок");
				ErrorManager.LogError(e);
				throw;
			}
		}
