...
//				var number = currentInfo.Attributes.Length * 80 / 100;
//				for (var j = 0; j < currentInfo.Attributes.Length; j++)
//				{
//					if (j > number)
//						break;

//					attributesInfo.Add($"Имя {i}");
//					attributesInfo.Add($"Реестр {i}");
//				}
...
//			var maxNumberOfAttributes = info.Max(x => x.Attributes.Length) * 80 / 100;
