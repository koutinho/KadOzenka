	...
	public class OksReportLongProcess : ALinearReportsLongProcessTemplate<OksReportLongProcess.ReportItem, ReportLongProcessOnlyTasksInputParameters>
	{
		...
		protected override List<Column> GenerateReportHeaders()
		{
			var columns = new List<Column>
			{
				...
				new Column {Header = "Год ввода в эксплуатацию", Width = 5},
				new Column {Header = "Год постройки", Width = 4}, 
				new Column {Header = "Дата образования", Width = 4},
				new Column {Header = "Количество подземных этажей", Width = 4},
				new Column {Header = "Количество этажей", Width = 4},
				new Column {Header = "Материал стен", Width = 4},
				new Column {Header = "Местоположение", Width = ColumnWidthForAddresses},
				new Column {Header = "Адрес", Width = ColumnWidthForAddresses},
				new Column {Header = "Назначение здания", Width = 4},
				new Column {Header = "Наименование объекта", Width = 4},
				new Column {Header = "Площадь", Width = 4},
				new Column {Header = "Тип объекта", Width = 4},
				new Column {Header = "Кадастровый квартал", Width = 4},
				new Column {Header = "Значение кадастровой стоимости", Width = 4},
				...
				new Column {Header = "Номер акта об утверждении кадастровой стоимости", Width = 4},
				new Column {Header = "Дата акта об утверждении кадастровой стоимости", Width = ColumnWidthForDates},
				new Column {Header = "Наименование документа об утверждении кадастровой стоимости", Width = 4},
