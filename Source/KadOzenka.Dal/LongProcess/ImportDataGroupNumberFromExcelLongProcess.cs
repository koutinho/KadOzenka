...
{
	public class ImportDataGroupNumberFromExcelLongProcess : LongProcess
	{
		public const string LongProcessName = "ImportDataGroupNumberFromExcelLongProcess";

		public static void AddProcessToQueue(Stream stream, ImportDataGroupNumberFromExcelDto settings)
		{
		...
		public override void StartProcess(OMProcessType processType, OMQueue processQueue, CancellationToken cancellationToken)
		{
			...
			try
			{
				...
				var settings = processQueue.Parameters.DeserializeFromXml<ImportDataGroupNumberFromExcelDto>();
				...
				{
					DataImporterKO.ImportDataGroupNumberFromExcelByUnitStatus(excelFile, settings, import);
				}
				else
				{
					DataImporterKO.ImportDataGroupNumberFromExcelByTaskFilter(excelFile, settings, import);
				}
