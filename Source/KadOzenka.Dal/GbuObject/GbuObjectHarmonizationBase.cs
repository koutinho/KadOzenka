...
namespace KadOzenka.Dal.GbuObject
{
	public class HarmonizationItemsGetter : AItemsGetter<Item>
	{
        ...
        {
	        Logger.Debug("Получение объектов по списку заданий на оценку");
            ...
            BaseSetting.TaskFilter.ForEach(taskId =>
            {
                var units = OMUnit
                    ...
                    .Execute();
                Logger.Debug($"Загружено {units.Count} юнитов для задания на оценку {taskId}");
            ...
            Logger.Debug($"Общее количество загруженных объектов: {objects.Count}");
        ...
        {
	        Logger.Debug("Получение объектов");
            ...
            Logger.Debug($"Общее количество загруженных объектов: {allObjects.Count}");
