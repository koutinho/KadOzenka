...
namespace KadOzenka.Dal.GbuObject
{
    ...
    public class HarmonizationCOD
    {
        ...
        public static void Run(HarmonizationCODSettings setting)
        {
            ...
            Parallel.ForEach(Objs, options, item => { RunOne(item, setting, DictionaryItem); });
        }

        public static void RunOne(ObjectModel.Gbu.OMMainObject obj, HarmonizationCODSettings setting, List<ObjectModel.KO.OMCodDictionary> dictionaryItem)
        {
