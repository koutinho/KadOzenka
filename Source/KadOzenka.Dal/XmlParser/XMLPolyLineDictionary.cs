    ...
    class XMLPolyLineDictionary
    {
        ...
        public static string getCorrectNameForRegion(string name)
        {
            switch (name)
            {
                ...
                case "СП Внуковское":
                case "Внуковское, поселение":
                    return "Внуковское";
                case "СП Воскресенское":
                case "Воскресенское, поселение":
                    return "Воскресенское";
                case "СП Десеновское":
                case "Десёновское, поселение":
                    return "Десёновское";
                case "СП Кокошкино":
                case "Кокошкино, поселение":
                    return "Кокошкино";
                case "СП Марушкинское":
                case "Марушкинское, поселение":
                    return "Марушкинское";
                case "СП Московский":
                case "Московский, поселение":
                    return "Московский";
                case "СП \"Мосрентген\"":
                case "Мосрентген, поселение":
                    return "Мосрентген";
                case "СП Рязановское":
                case "Рязановское, поселение":
                    return "Рязановское";
                case "СП Сосенское":
                case "Сосенское, поселение":
                    return "Сосенское";
                case "СП Филимонковское":
                case "Филимонковское, поселение":
                    return "Филимонковское";
                case "ГО Щербинка":
                case "Городской округ Щербинка":
                    return "Щербинка";
                case "СП Вороновское":
                case "Вороновское, поселение":
                    return "Вороновское";
                case "СП Киевский":
                case "Киевский, поселение":
                    return "Киевский";
                case "СП Кленовское":
                case "Клёновское, поселение":
                    return "Клёновское";
                case "СП Краснопахорское":
                case "Краснопахорское, поселение":
                    return "Краснопахорское";
                case "СП Михайлово-Ярцевское":
                case "Михайлово-Ярцевское, поселение":
                    return "Михайлово-Ярцевское";
                case "СП Новофедоровское":
                case "Новофёдоровское, поселение":
                    return "Новофёдоровское";
                case "СП Первомайское":
                case "Первомайское, поселение":
                    return "Первомайское";
                case "СП Роговское":
                case "Роговское, поселение":
                    return "Роговское";
                case "ГО Троицк":
                case "Городской округ Троицк":
                    return "Троицк";
                case "СП Щаповское":
                case "Щаповское, поселение":
                    return "Щаповское";
            }
            return name;
        }
