...
{
    public class XmlToExcelExportOld
    {
        ...
        public XmlToExcelExportOld(xmlObjectList objectList, int[] config)
        {
            _config = config;
        ...
        private void AddParcels(ExcelWorksheet sheet, List<xmlObjectParcel> parcels)
        {
            ...
            foreach (var item in parcels)
            {
				...
				AddEntry(sheet, item.Adress.OKATO, ReadConfigValue(valOffset + 17), 17, curRow);AddEntry(sheet, item.Adress.KLADR,  ReadConfigValue(valOffset + 17), 17, curRow);
                ...
                AddEntry(sheet, item.Adress.Other, ReadConfigValue(valOffset + 21), 21, curRow);AddEntry(sheet, item.Adress.AddressOrLocation, ReadConfigValue(valOffset + 21), 21, curRow);
                ...
                AddEntry(sheet, item.Adress.Apartment?.Value, ReadConfigValue(valOffset + 30), 30, curRow);AddEntry(sheet, item.Adress.InBounds, ReadConfigValue(valOffset + 30), 30, curRow);
...
AddEntry(sheet, item.Adress.FIAS, ReadConfigValue(valOffset + 17), 17, curRow);
                ...
                AddEntry(sheet, item.Adress.Other, ReadConfigValue(valOffset + 20), 20, curRow);AddEntry(sheet, item.Adress.AddressOrLocation, ReadConfigValue(valOffset + 21), 21, curRow);
        ...
        private void AddIncompleteBuildings(ExcelWorksheet sheet, List<xmlObjectUncomplited> incompletedBuildings)
        {
            ...
            foreach (var item in incompletedBuildings)
            {
                ...
                AddEntry(sheet, item.Adress.FIAS, ReadConfigValue(valOffset + 17), 17, curRow);
				AddEntry(sheet, item.Adress.OKATO, ReadConfigValue(valOffset + 17), 17, curRow);AddEntry(sheet, item.Adress.KLADR, ReadConfigValue(valOffset + 16), 16,  curRow);
				AddEntry(sheet, item.Adress.OKTMO, ReadConfigValue(valOffset + 17), 17,curRow);
                AddEntry(sheet, item.Adress.PostalCode, ReadConfigValue(valOffset + 17), 17,  curRow);
				AddEntry(sheet, item.Adress.RussianFederation, ReadConfigValue(valOffset + 18), 18,curRow);
                AddEntry(sheet, item.Adress.Region, ReadConfigValue(valOffset + 18), 18, curRow);
