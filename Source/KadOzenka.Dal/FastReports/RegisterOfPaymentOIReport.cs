...
{
    public class RegisterOfPaymentOIReport : FastReportBase
    {
        protected override string TemplateName(NameValueCollection query) { { return "RegisterOfPaymentOIReport"; } }
