...
{
    public class UncompletedBuildingReport : BaseReport
    {
        ...
        private Dictionary<string, RegisterAttribute> GetAttributesForReport(long tourId, InputParameters inputParameters)
        {
            ...
            attributesDictionary.Add(nameof(ReportItem.ReadinessPercentage), StatisticalDataService.GetRosreestrReadinessPercentageAttribute());
