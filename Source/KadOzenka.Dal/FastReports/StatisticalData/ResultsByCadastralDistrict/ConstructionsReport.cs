...
{
    public class ConstructionsReport : StatisticalDataReport
    {
        ...
        private Dictionary<string, RegisterAttribute> GetAttributesForReport(InputParameters inputParameters)
        {
            ...
            attributesDictionary.Add(nameof(RosreestrAttributes.ConstructionPurpose), StatisticalDataService.GetRosreestrConstructionPurposeAttribute());
        ...
        private DataTable GetItemDataTable(List<ReportItem> operations)
        {
            ...
            for (var i = 0; i < operations.Count; i++)
            {
                dataTable.Rows.Add(i + 1,
                    ...
                    operations[i].RosreestrAttributes.ConstructionPurpose,
