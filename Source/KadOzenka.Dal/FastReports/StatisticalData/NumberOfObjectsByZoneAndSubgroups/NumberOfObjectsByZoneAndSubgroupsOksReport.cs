...
{
	public class NumberOfObjectsByZoneAndSubgroupsOksReport : StatisticalDataReport
	{
		private readonly NumberOfObjectsByZoneAndSubgroupsService _service;
		private readonly ILogger _logger;
		protected override ILogger Logger => _logger;

		public NumberOfObjectsByZoneAndSubgroupsOksReport()
		{
			_service = new NumberOfObjectsByZoneAndSubgroupsService(StatisticalDataService);
			_logger = Log.ForContext<NumberOfObjectsByZoneAndSubgroupsOksReport>();
		}
		...
		protected override DataSet GetReportData(NameValueCollection query, HashSet<long> objectList = null)
		{
			...
			var data = _service.GetNumberOfObjectsByZoneAndSubgroupsData(firstTourId.Value,
				secondTourId.Value, reportType, true);
