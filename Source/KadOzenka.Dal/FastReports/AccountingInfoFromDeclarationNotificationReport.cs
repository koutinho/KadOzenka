...
namespace KadOzenka.Dal.FastReports
{
	public class AccountingInfoFromDeclarationNotificationReport : DeclarationNotificationReport
	{
		...
		{
			var mainData =
				"\u0009В\u00A0соответствии с\u00A0пунктом 13 приказа Минэкономразвития России от\u00A004.06.2019 №\u00A0318 «Об\u00A0утверждении Порядка рассмотрения декларации о\u00A0характеристиках объекта недвижимости, " +
