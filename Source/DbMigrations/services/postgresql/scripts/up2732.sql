...
-- Обновление Enum'а
INSERT INTO public.core_reference (referenceid, description, readonly, progid, istree, defaultvalue, name, register_id, simple_values) VALUES (220, 'Тип выгрузки результатов кадастровой оценки', 1, 'Core.RefLib.Executors.ReferenceExecutorSimple', null, null, 'KoUnloadResultType', null, '[
    {
		"Id": 0,
		"Value": "Тип не указан",
		"Name": "None"
...
on conflict (referenceid) do update set simple_values=
'[   {
      "Id": 0,
      "Value": "Тип не указан",
      "Name": "None"
